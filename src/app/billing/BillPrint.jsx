...
const BillPrint = ({ bill, onClose }) => {
  ...
  const handlePrint = () => {
   ...
   var originalContents = document.body.innerHTML;
    ...
    window.print();
    document.body.innerHTML = originalContents; // Clear the body after printing
  ...
  return (
    <Box>
      <Box ref={printRef}>
        <Paper className="bill-paper" elevation={6} sx={{
          ...
          <Box className="bill-header" sx={{
            ...
            <Box>
              <Typography className="bill-title" sx={{
            ...
            <Box sx={{ textAlign: { xs: 'left', sm: 'right' }, mt: { xs: 2, sm: 0 } }}>
              <Typography className="bill-company" variant='h5' fontWeight={'800'}>
                Thakur Eye Hospital
              </Typography>
              <Typography className="bill-contact">
                Near Head, Post Office,Kunjpura Road, Karnal-132001 <br />
                Phone: 0184-4063673, 8930899601, 9466182883 <br />
                Email: bkt20042003@gmail.com
              </Typography>
            </Box>
          </Box>
          <Divider sx={{ mb: 2 }} />
